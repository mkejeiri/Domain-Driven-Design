...
According to [Alberto Brandolini](https://leanpub.com/introducing_eventstorming) eBook (Event storming), When modeling large scale system, we shouldn’t aim for a large “enterprise model”. That’s an attractor for ambiguities and contradictions. Instead we should aim for 2 things:
